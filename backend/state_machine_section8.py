...
# Perguntas da Seção 8 (fonte: _pacotao_2.txt - Seção F)
SECTION8_QUESTIONS = {
    "8.1": "Quem deu voz de prisão e por qual crime?",
    "8.2": "Havia agravantes? (art. 40 Lei 11.343/06 - armas, menores, escolas, associação)",
    "8.3": "O preso declarou algo? (transcrição literal ou se permaneceu em silêncio)",
    "8.4": "O preso possui registros anteriores? (REDS - Registro de Eventos de Defesa Social)",
    "8.5": "O preso possui vínculo com facção criminosa?",
    "8.6": "Garantias asseguradas + destino de pessoas/materiais (direitos, integridade física, CEFLAN/delegacia)"
}

SECTION8_STEPS = ["8.1", "8.2", "8.3", "8.4", "8.5", "8.6", "complete"]
...
class BOStateMachineSection8:
    ...
    - NÃO tem pergunta condicional: todas as 6 perguntas devem ser respondidas
