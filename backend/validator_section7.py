# -*- coding: utf-8 -*-
"""
Validador de respostas para Seção 7: Testemunhas e Filmagens
REFATORADO - Usa Strategy Pattern (v0.13.1)

Reduzido de 229 → ~30 linhas (87% menos código)
...
class ResponseValidatorSection7:
    ...
    Elimina duplicação de código (~200 linhas) mantendo compatibilidade total.
    """
    ...
    def validate(cls, question_id: str, answer: str, context: Dict[str, Any] = None) -> Tuple[bool, str]:
        ...
        Args:
            question_id: ID da pergunta (ex: "7.1", "7.2", etc.)
